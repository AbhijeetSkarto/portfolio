            ...
            <div className="bg-card border border-border rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:abhijeet@onlinestartup.store" className="block text-primary hover:underline">
                      abhijeet@onlinestartup.store
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-3">
                  ...
                  <a href="mailto:abhijeet@onlinestartup.store" className="bg-primary/10 p-2 rounded-full text-primary hover:bg-primary hover:text-primary-foreground transition-colors" title="Email">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
